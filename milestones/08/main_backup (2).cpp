...
#pragma region INITIALIZATION
    ...
    double d_size_x = (coeff_x);
    double d_size_y = (coeff_y);
    double d_size_z = (coeff_z);
    ...
    Domain domain(MPI_COMM_WORLD, 2*d_size, d_decomposition, d_periodicity);
